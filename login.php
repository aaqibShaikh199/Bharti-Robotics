...
<body class="bg-light bg-gradient">
   <div class="h-100 d-flex jsutify-content-center align-items-center">
       <div class='w-100'>
        <h3 class="py-5 text-center text-light">MessageByte</h3>
        ...
        <div class="card my-3 col-md-4 offset-md-4">
            <div class="card-body">
                ...
                <form action="" id="login-form">
                    ...
                    <center><b>MessageByte Web Application <br>User login</center>
                    ...
                    <div class="form-group d-flex w-100 justify-content-between">
                        ...
                        <br><button class="btn btn-sm btn-primary rounded-0 my-1">Login</button>
                    </div>
                </form>
            </div>
        </div>
